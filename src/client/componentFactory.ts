      ...
      <div class="opening-content-view-tn">
          ...
          <div class="inner-content-tn">
            <div class="inner-content-block-tn">
              ...
              Let's go!</button>
              <div class="opening-heading-tn">${openingHeading}</div>
            </div>
          </div>
      </div>
  `;
...
export const issuerConnectTabMarkup = (title:string, issuer:string) => {
  return `
...
export const issuerConnectIframeMarkup = (title:string, issuer:string) => {
  return `
    <li class="issuer-connect-banner-tn" data-issuer="${issuer}" role="menuitem">
      <p class="issuer-connect-title">${title}</p>
