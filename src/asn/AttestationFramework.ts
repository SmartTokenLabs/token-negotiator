...
export class SignedInfo {
	...
	public signature!: AlgorithmIdentifierASN; // AlgorithmIdentifier,
	@AsnProp({ type: Name }) public issuer!: Name; // Name,
	@AsnProp({ type: ValidityValue, optional: true })
	public validity?: ValidityValue; // Validity,
	...
	public contract?: SmartContract; // contract             SEQUENCE OF SmartContract OPTIONAL,
...
export class MyAttestation {
	...
	@AsnProp({ type: AsnPropTypes.Any }) public signedInfo: Uint8Array =
		new Uint8Array();
	// @AsnProp({ type: SignedInfo }) public signedInfo:SignedInfo;
	@AsnProp({ type: AlgorithmIdentifierASN })
	public signatureAlgorithm!: AlgorithmIdentifierASN;
