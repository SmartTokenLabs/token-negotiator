...
var TicketZKProof = (function (_super) {
    ...
    TicketZKProof.prototype.getTokenProof = function (issuerConfig, tokens, web3WalletProvider, request) {
        var _a;
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        unChallenge = new SignedUNChallenge();
                        request.options = __assign(__assign({}, request.options), { unEndPoint: issuerConfig.unEndPoint });
                        return [4, unChallenge.getTokenProof(issuerConfig, tokens, web3WalletProvider, request)];
                    case 1:
                        unRes = _b.sent();
                    ...
                    case 3:
                        ...
                        if (useEthKey) {
                            Authenticator.validateUseTicket(res.data.proof, issuerConfig.base64attestorPubKey, issuerConfig.base64senderPublicKeys, (_a = useEthKey.address) !== null && _a !== void 0 ? _a : "");
