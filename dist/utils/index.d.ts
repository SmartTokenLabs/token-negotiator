export declare const logger: (item: any) => void;
...
export declare const asyncHandle: (promise: any) => Promise<any[]>;
export declare const attachPostMessageListener: (listener: any) => void;
export declare const splitOnChainKey: (onChainKey: string) => {
    address: string;
    chain: string;
    openSeaSlug: string;
};
