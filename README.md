...
2. Download and then install this folder into your project `/token-negotiator-1.0.19-alpha-dist`
...
````html
  ...
  <!-- add the JS library -->
  <script type="text/javascript" src="./token-negotiator-1.0.19-alpha-dist/negotiator.js"></script>
